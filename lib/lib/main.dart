...
// import 'package:mazegame/random_queue.dart';
    ...
    return Container(
        child: Column(
          children: <Widget>[
            Container(
                decoration:
                BoxDecoration(borderRadius: BorderRadius.circular(30), border: Border.all(color: Colors.blue, width: 3)),
                child: IconButton(
                ...
                children: <Widget>[
                  Container(
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(30), border: Border.all(color: Colors.blue, width: 3)),
        ...
        showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                actions: <Widget>[
                  new FlatButton(
                    child: new Text('重新挑战本关', style: TextStyle(fontSize: 16)),
                    onPressed: () {
                      isTip = false;
                      setState(() {
                        _model.playerX = _model.getStartX();
